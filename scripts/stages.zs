...
ItemStages.createModRestriction("industrialforegoing", "industrialforegoing");
...
ItemStages.createModRestriction("aether", "aether");
ReDimensionStages.restrict("aether:the_aether", "aether");

ItemStages.createModRestriction("avaritia", "final");
